  ...
  return (
    <Layout>
      <PageContainer className="pageAnimation">
        ...
        <Text>
          Le site pivotpanda.com est édité par Pivot Panda, SAS, domiciliée à 55
          rue Sylvabelle, 13006, Marseille. <br /> Email :
          contact@pivotpanda.com <br /> Le directeur de la publication du site
          web "pivotpanda.com" est Guillaume Tanguy. <br /> Le site
          pivotpanda.com est hébergé par OVH SAS, dont le siège social est situé
        ...
        <StyledSectionTitle>Données personnelles et cookies</StyledSectionTitle>
        <Text>
          Ce site ne collecte aucune donnée personnelle des visiteurs et
          n'utilise pas de cookies. Aucune information personnelle identifiable
          n'est demandée ni enregistrée lors de la navigation sur ce site. Par
          conséquent, aucune donnée personnelle n'est partagée, vendue ou
          transférée à des tiers. <br /> Cookies : Ce site n'utilise pas de
          cookies. Les cookies sont de petits fichiers texte stockés sur votre
          ordinateur ou votre appareil lorsque vous visitez certains sites web.
          Comme ce site ne collecte pas de données personnelles, il n'est pas
          nécessaire d'utiliser des cookies
        </Text>
